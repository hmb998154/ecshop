...
return array(
	...
	'APP' => array(
		...
		'LOG_PATH' => ROOT_PATH . 'data/caches/logs/', // 出错信息存放的目录，出错信息以天为单位存放，一般不需要修改
		...
		'HTML_CACHE_PATH' => ROOT_PATH . 'data/caches/html_cache/', // 静态页面缓存目录，一般不需要修改
	...
	'DB' => array(
		...
		/* 文件缓存配置 */
		'DB_CACHE_PATH' => ROOT_PATH . 'data/caches/caches/', // 数据库查询内容缓存目录，地址相对于入口文件，一般不需要修改
	...
	'TPL' => array(
		...
		/* 普通文件缓存 */
		'TPL_CACHE_PATH' => ROOT_PATH . 'data/caches/tpl_cache/', // 模板缓存目录，一般不需要修改
