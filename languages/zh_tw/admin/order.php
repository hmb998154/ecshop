...
$_LANG['notice_gb_ship'] = '備註：團購活動未處理爲成功前，不能發貨';
...
$_LANG['merge'] = '合併';
$_LANG['notice_order_sn'] = '當兩個訂單不一致時，合併後的訂單信息（如：支付方式、配送方式、包裝、賀卡、紅包等）以主訂單爲準。';
...
$_LANG['order'] = '訂單：';
$_LANG['confirm_order'] = '以下訂單無法設置爲確認狀態';
$_LANG['invalid_order'] = '以下訂單無法設置爲無效';
...
$_LANG['order_amount_change'] = '訂單總金額由 %s 變爲 %s';
$_LANG['shipping_note'] = '說明：因爲訂單已發貨，修改配送方式將不會改變配送費和保價費。';
...
$_LANG['delivery_sn_number'] = '發貨單流水號：';
