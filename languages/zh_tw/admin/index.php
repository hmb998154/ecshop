...
$_LANG['order_print_canntwrite'] = 'data目錄下的order_print.html文件屬性爲不可寫，您將無法修改訂單打印模板。';
$_LANG['shop_closed_tips'] = '您的商店已被暫時關閉。在設置好您的商店之後別忘記打開哦！';
$_LANG['empty_upload_tmp_dir'] = '當前的上傳臨時目錄爲空，您可能無法上傳文件，請檢查 php.ini 中的設置。';
...
$_LANG['shop_back_in'] = '進入網店後臺';
$_LANG['goods_img_too_big'] = '商品圖片文件太大了（最大值:%s），無法上傳。';
$_LANG['invalid_goods_img'] = '商品圖片格式不正確！';


//JS語言
$_LANG['js_languages']['shop_name_not_null'] = '商店名稱不能爲空';
$_LANG['js_languages']['good_name_not_null'] = '商品名稱不能爲空';
$_LANG['js_languages']['good_category_not_null'] = '商品分類不能爲空';
