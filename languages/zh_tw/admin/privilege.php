...
/* 提示信息 */
$_LANG['js_languages']['user_name_empty'] = '管理員用戶名不能爲空!';
$_LANG['js_languages']['password_invaild'] = '密碼必須同時包含字母及數字且長度不能小於6!';
$_LANG['js_languages']['email_empty'] = 'Email地址不能爲空!';
...
$_LANG['email_notic'] = '輸入管理員的Email郵箱,必須爲Email格式';
$_LANG['confirm_notic'] = '輸入管理員的確認密碼,兩次輸入必須一致';

/* 登錄表單 */
$_LANG['label_username'] = '請填寫您註冊的郵箱或手機';
$_LANG['label_password'] = '請輸入密碼';
$_LANG['label_captcha'] = '輸入驗證碼';
$_LANG['click_for_another'] = '看不清？點擊更換另一個驗證碼。';
$_LANG['signin_now'] = '登 錄';
$_LANG['remember'] = '自動登錄';
?>