...
$_LANG['error_tips'] = '請用雲起賬號登陸後臺，進行設置！';
$_LANG['enable_old'] = '啓用已有賬號';
...
$_LANG['msg'] = '消息內容';
$_LANG['msg_notice'] = '每條短信最長67字符，簽名已經默認，不需要添加簽名。（如未設置簽名點擊 <a href="sms.php?act=sms_sign">設置</a>）';
$_LANG['msg_forbidden'] = '內容裏請不要出現"test"或者"測試"這樣的字眼，否則可能會被運營商攔截';
$_LANG['send_date'] = '定時發送時間';
$_LANG['send_date_notice'] = '格式爲YYYY-MM-DD HH:II。爲空表示立即發送。';
$_LANG['back_send_history'] = '返回發送歷史列表';
$_LANG['back_charge_history'] = '返回充值歷史列表';
$_LANG['sms_preview'] = '短信預覽';
$_LANG['notice0'] = '已輸入';
$_LANG['notice1'] = '個字符，約';
$_LANG['notice2'] = '條短信長度 短信內容的實際長度以最終發出的結果爲準';

/* 記錄查詢界面 */
$_LANG['start_date'] = '開始日期';
$_LANG['date_notice'] = '格式爲YYYY-MM-DD。可爲空。';
$_LANG['end_date'] = '結束日期';
$_LANG['page_size'] = '每頁顯示數量';
$_LANG['page_size_notice'] = '可爲空，表示每頁顯示20條記錄';
$_LANG['page'] = '頁數';
$_LANG['page_notice'] = '可爲空，表示顯示1頁';
$_LANG['charge'] = '請輸入您想要充值的金額';

/* 動作確認信息 */
$_LANG['history_query_error'] = '對不起，在查詢過程中發生錯誤。';
$_LANG['enable_ok'] = '恭喜，您已成功啓用短信服務！';
$_LANG['enable_error'] = '對不起，您啓用短信服務失敗。';
...
/* API返回的錯誤信息 */
//--註冊
$_LANG['api_errors']['register'][1] = '域名不能爲空。';
...
$_LANG['server_errors'][2] = '啓用信息無效。';//ERROR_INVALID_ENABLE_INFO
...
$_LANG['server_errors'][7] = 'HTTP響應體爲空。';//ERROR_EMPTY_RESPONSE
...
/* 客戶端JS語言項 */
//--註冊或啓用
$_LANG['js_languages']['password_empty_error'] = '密碼不能爲空。';
$_LANG['js_languages']['username_empty_error'] = '用戶名不能爲空。';
$_LANG['js_languages']['username_format_error'] = '用戶名格式不對。';
$_LANG['js_languages']['domain_empty_error'] = '域名不能爲空。';
$_LANG['js_languages']['domain_format_error'] = '域名格式不對。';
$_LANG['js_languages']['send_empty_error'] = '發送手機號與發送等級至少填寫一項！';
$_LANG['js_languages']['sms_empty_error'] = '短信內容長度不爲空';
//--發送
