...
$_LANG['goods_free_shipping'] = '此商品爲免運費商品，計算配送金額時將不計入配送費用';
...
$_LANG['minute'] = '分鐘';
$_LANG['compare'] = '比較';
$_LANG['volume_price'] = '購買商品達到以下數量區間時可享受的優惠價格';
$_LANG['number_to'] = '數量';
...
$_LANG['compare_js']['count_limit'] = '最多隻能選擇4個商品進行對比';
...
$_LANG['tag_exists'] = '您已經爲該商品添加過一個標記，請不要重複提交.';
$_LANG['tag_cloud'] = '標籤雲';
$_LANG['tag_anonymous'] = '對不起，只有註冊會員並且正常登錄以後才能提交標記。';
$_LANG['tag_cloud_desc'] = '標籤雲（Tag cloud）是用以表示一個網站中的內容標籤。 標籤（tag、關鍵詞）是一種更爲靈活、有趣的商品分類方式，您可以爲每個商品添加一個或多個標籤，那麼可以通過點擊這個標籤查看商品其他會員提交的與您的標籤一樣的商品,能夠讓您使用最快的方式查找某一個標籤的所有網店商品。比方說點擊“紅色”這個標籤，就可以打開這樣的一個頁面，顯示所有的以“紅色” 爲標籤的網店商品';
...
$_LANG['no_basic_goods'] = '對不起，您希望將該商品做爲配件購買，可是購物車中還沒有該商品的基本件。';
$_LANG['cannt_alone_sale'] = '對不起，該商品不能單獨銷售。';
$_LANG['shortage'] = "對不起，該商品已經庫存不足暫停銷售。\n你現在要進行缺貨登記來預訂該商品嗎？";
$_LANG['shortage_little'] = "該商品已經庫存不足。已將您的購貨數量修改爲 %d。\n您現在要去購物車嗎？";
...
$_LANG['cmt_submit_wait'] = "您的評論已成功發表, 請等待管理員的審覈!";
...
$_LANG['cmt_spam_warning'] = '您至少在30秒後纔可以繼續發表評論!';
$_LANG['cmt_lang']['captcha_not_null'] = '驗證碼不能爲空!';
...
/* 其他信息 */
$_LANG['js_languages']['goodsname_not_null'] = '商品名不能爲空！';
...
/* 奪寶奇兵 */
$_LANG['snatch_js']['price_not_null'] = '價格不能爲空';
...
$_LANG['price_extent'] = '出價範圍爲';
$_LANG['user_to_use_up'] = '用戶可多次出價，每次消耗';
$_LANG['snatch_victory_desc'] = '當本期活動截止時，系統將從所有競價獎品的用戶中，選出在所有競價中出價最低、且沒有其他出價與該價格重複的用戶（即最低且唯一競價），成爲該款獎品的獲勝者.';
...
$_LANG['can_use_integral'] = '您當前的可用積分爲';
$_LANG['noworder_can_integral'] = '本訂單最多可以使用';
$_LANG['use_surplus'] = '使用餘額';
$_LANG['your_surplus'] = '您當前的可用餘額爲';
$_LANG['pay_fee'] = '支付手續費';
...
$_LANG['order_payed_to_customer_sms'] = '訂單 %s 付款了，付款金額：%s，我們將立即配貨發貨。';
...
$_LANG['pay_disabled'] = '此支付方式還沒有被啓用！';
...
/* 虛擬商品 */
$_LANG['virtual_goods_ship_fail'] = '自動發貨失敗，請儘快聯繫商家重新發貨';
...
$_LANG['promotion_time'] = '的時間爲%s到%s，趕快來搶吧！';
...
$_LANG['gb_notice_login'] = '提示：您需要先註冊成爲本站會員並且登錄後，才能參加商品團購!';
...
$_LANG['au_bid_after_login'] = '您只有註冊成爲會員並且登錄之後才能出價';
...
$_LANG['hash_wrong'] = '驗證串錯誤！請覈對驗證串或輸入email地址重新發送驗證串！';
...
$_LANG['message_board_js']['msg_title_empty'] = '留言標題爲空';
$_LANG['message_board_js']['msg_content_empty'] = '留言內容爲空';
$_LANG['message_board_js']['msg_captcha_empty'] = '驗證碼爲空';
$_LANG['message_board_js']['msg_title_limit'] = '留言標題不能超過200個字';
$_LANG['message_submit_wait'] = '您的留言已成功發表, 請等待管理員的審覈!';
